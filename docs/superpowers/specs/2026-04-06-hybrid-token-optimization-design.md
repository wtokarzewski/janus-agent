...
|---------|--------|--------|
| Dual cache markers | Nanobot | `607fd8f` |
| Compact newest-first | OpenClaw | `f6380ae4` |
| Tool pair preservation | OpenClaw | `08992e1d` |
| MCP artifact storage | PicoClaw | `d8c5183` |
| Overflow patterns | Pi-Mono | `39b1bf7b` |
| 1-retry overflow limit | Pi-Mono | compaction test suite |
| Cache hit rate display | Nanobot | `da08dee` |
